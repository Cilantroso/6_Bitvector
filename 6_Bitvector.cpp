...
void parseStatusBits(){
	...
	std::cout << "Tiene piedra filosofal? " << translateBool(playerStatus[9]) << "\n";
	std::cout << "Tiene cristal de fusion? " << translateBool(playerStatus[10]) << "\n";
	std::cout << "Tiene albondiga de ikea? " << translateBool(playerStatus[11]) << "\n";
	std::cout << "Tiene una morb orb? " << translateBool(playerStatus[12]) << "\n";
	std::cout << "Tiene un martillo rojo? " << translateBool(playerStatus[13]) << "\n";
	std::cout << "Tiene una hoz amarilla? " << translateBool(playerStatus[14]) << "\n";
	std::cout << "Tiene el libro magico? " << translateBool(playerStatus[15]) << "\n";
